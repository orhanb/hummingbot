...
class BtcturkExchangeTests(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.exchange = BtcturkExchange(
            btcturk_api_key="testAPIKey",
            btcturk_api_secret="testSecret",
            trading_pairs=[self.trading_pair],
        )

        self.exchange.logger().setLevel(1)
        self.exchange.logger().addHandler(self)
        self.exchange._btcturk_time_synchronizer.logger().setLevel(1)
        self.exchange._btcturk_time_synchronizer.logger().addHandler(self)
